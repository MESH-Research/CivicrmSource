<?php
/**
 * COmanage Registry CiviCRM Source Controller
 *
...
class CivicrmSourcesController extends SOISController {
  // Class name, used by Cake
  public $name = "CivicrmSources";
  ...
  function checkWriteDependencies($reqdata, $curdata = null) {
    ...
    try {
      $this->loadModel('CivicrmSource.CivicrmSourceBackend');
      
      $this->CivicrmSourceBackend->verifyCivicrmServer($reqdata['CivicrmSource']['apiroot'],
                                               $reqdata['CivicrmSource']['sitekey'],
                                               $reqdata['CivicrmSource']['userkey']);
    }
  ...
  function isAuthorized() {
    ...
    // Delete an existing CiviCRM Source?
    $p['delete'] = $roles['cmadmin'] || $coadmin;

    // Edit an existing CiviCRM Source?
    $p['edit'] = $roles['cmadmin'] || $coadmin;

    // View all existing CiviCRM Source?
    $p['index'] = $roles['cmadmin'] || $coadmin;

    // View an existing CiviCRM Source?
